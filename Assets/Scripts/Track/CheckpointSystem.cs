...
public class CheckpointSystem : MonoBehaviour
{
    ...
    public GameObject[] checkpointList_ThisIsAutoGenerated; //editor visible list of checkpoints, use Checkpoints.list in other scripts
    ...
    void UpdateCheckpointList()
    {
        ...
        checkpointList_ThisIsAutoGenerated = finalList.ToArray();
